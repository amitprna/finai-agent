...
1. WEB RESEARCH (1-2 pages MAX):
   - Use clean, fast sources first (Google Finance, MarketWatch, or CNBC)
   - Avoid ad-heavy, tracker-heavy landing pages (e.g., avoid Yahoo Finance homepage; prefer Google Finance or direct links to specific quotes/articles)
