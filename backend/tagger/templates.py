"""
Prompt Templates for the Instrument Tagger Agent
Defines prompt structures that direct the LLM tagger agent
to categorize asset classes, sector weights, and geographic distributions.
"""
...
1. Current market price per share in INR
...
Examples:
- NIFTYBEES.NS (Nifty 50 ETF): 100% equity, 100% asia, distributed across sectors based on Nifty 50 composition
- GILT5YBEES.NS (G-Sec Bond ETF): 100% fixed_income, 100% asia, 100% government_related
- RELIANCE.NS (Reliance Industries stock): 100% equity, 100% asia, split between energy (60%), communication (20%), and consumer_discretionary (20%)
- GOLDBEES.NS (Gold ETF): 100% commodities, 100% global, 100% commodities
...
Provide:
1. Current price per share in INR (approximate market price as of late 2024/early 2025/2026)
