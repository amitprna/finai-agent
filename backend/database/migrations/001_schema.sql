-- FinAI Financial Planner Database Schema
-- Version: 001
...
-- Minimal users table (Cognito handles auth)
CREATE TABLE IF NOT EXISTS users (
    ...
    region_targets JSONB DEFAULT '{"india": 50, "international": 50}',
...
CREATE TABLE IF NOT EXISTS instruments (
    ...
    allocation_regions JSONB DEFAULT '{}',      -- {"india": 60, "europe": 20, "usa": 20}
...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    cash_interest DECIMAL(5,4) DEFAULT 0,   -- Annual interest rate (0.075 = 4.5%)
