...
Defines prompt structures that direct the LLM retirement specialist
to execute wealth accumulations projections, interpret Monte Carlo findings,
and draft retirement preparedness plans.
"""
...
Market Assumptions:
- Average equity returns: 12% annually
- Average bond returns: 7% annually
- Inflation rate: 6% annually
- Safe withdrawal rate: 4.5% initially
